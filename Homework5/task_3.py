...
def everything_for_your_cat(cats_data):
    """ Возвращает список владельцев с их котами.
        :param cats_data - список котов и их владельцев
        :return: строку вида: Имя_покупателя Фамилия_покупателя: Кличка_котика1, Возраст; ...;\n """
    our_str = ''
    users = {}

    for cat_data in cats_data:
        user = f'{cat_data[2]} {cat_data[3]}'
        cat = f'{cat_data[0]}, {cat_data[1]}'
        if user in users:
            users[user] += '; ' + cat
        else:
            users[user] = cat
