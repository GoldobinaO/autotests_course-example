...
def scrabble(word):
    """ Считает стоимость слова.
           :param word - строка
           :return: целое число, стоимость слова """
    cost = {'авеёинорст': 1, 'дклмпу': 2, 'бгья': 3, 'йы': 4, 'жзхцч': 5, 'фшэю': 8, 'щ': 10, 'ъ': 15}
    points = 0

    for key in cost.keys():
        for symbol in key:
            points += word.count(symbol) * cost[key]
